...
class Header extends Component{
  ...
  handleLogout() {
    ...
    render(){
        return (
            <React.Fragment>
                navbar navbar-expand-lg navbar-dark gradient-custom
                 <Navbar color="dark" dark expand="xl" fixed="top">
                    <div className="container">
                     <NavbarToggler onClick={this.toggleNav}></NavbarToggler>
                     <NavbarBrand className="mr-auto text-primary" href="https://medhatrust.org/login">
                     MCT Library
                     </NavbarBrand>
                 ...
                 <Modal isOpen={this.state.isRegisterOpen} toggle={this.toggleRegister}>
                     ...
                     <LocalForm model="user" onSubmit={(values) => {
                           this.toggleRegister();
                            ...
                            <FormGroup>    
                                 <Label htmlFor="roll">MSS ID.</Label>
                                <Control.text model=".roll" id="roll" name="roll" 
                            className="form-control" placeholder="MSS ID" validators={{required,minLength: minLength(3),maxLength:maxLength(12)}} />
